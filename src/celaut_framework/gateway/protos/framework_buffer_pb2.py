...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='framework_buffer.proto',
  package='framework_buffer',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x16\x66ramework_buffer.proto\x12\x10\x66ramework_buffer\"\x07\n\x05\x45mpty\"\xa4\x03\n\x06\x42uffer\x12\x12\n\x05\x63hunk\x18\x01 \x01(\x0cH\x00\x88\x01\x01\x12\x16\n\tseparator\x18\x02 \x01(\x08H\x01\x88\x01\x01\x12\x13\n\x06signal\x18\x03 \x01(\x08H\x02\x88\x01\x01\x12\x30\n\x04head\x18\x04 \x01(\x0b\x32\x1d.framework_buffer.Buffer.HeadH\x03\x88\x01\x01\x1a\xfa\x01\n\x04Head\x12\r\n\x05index\x18\x01 \x01(\x05\x12;\n\npartitions\x18\x02 \x03(\x0b\x32\'.framework_buffer.Buffer.Head.Partition\x1a\xa5\x01\n\tPartition\x12\x41\n\x05index\x18\x01 \x03(\x0b\x32\x32.framework_buffer.Buffer.Head.Partition.IndexEntry\x1aU\n\nIndexEntry\x12\x0b\n\x03key\x18\x01 \x01(\x05\x12\x36\n\x05value\x18\x02 \x01(\x0b\x32\'.framework_buffer.Buffer.Head.Partition:\x02\x38\x01\x42\x08\n\x06_chunkB\x0c\n\n_separatorB\t\n\x07_signalB\x07\n\x05_headb\x06proto3'
)
...
_EMPTY = _descriptor.Descriptor(
  name='Empty',
  full_name='framework_buffer.Empty',
  filename=None,
  file=DESCRIPTOR,
...
_BUFFER_HEAD_PARTITION_INDEXENTRY = _descriptor.Descriptor(
  name='IndexEntry',
  full_name='framework_buffer.Buffer.Head.Partition.IndexEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='framework_buffer.Buffer.Head.Partition.IndexEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='framework_buffer.Buffer.Head.Partition.IndexEntry.value', index=1,
...
_BUFFER_HEAD_PARTITION = _descriptor.Descriptor(
  name='Partition',
  full_name='framework_buffer.Buffer.Head.Partition',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='index', full_name='framework_buffer.Buffer.Head.Partition.index', index=0,
...
_BUFFER_HEAD = _descriptor.Descriptor(
  name='Head',
  full_name='framework_buffer.Buffer.Head',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='index', full_name='framework_buffer.Buffer.Head.index', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partitions', full_name='framework_buffer.Buffer.Head.partitions', index=1,
...
_BUFFER = _descriptor.Descriptor(
  name='Buffer',
  full_name='framework_buffer.Buffer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='chunk', full_name='framework_buffer.Buffer.chunk', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='separator', full_name='framework_buffer.Buffer.separator', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='signal', full_name='framework_buffer.Buffer.signal', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='head', full_name='framework_buffer.Buffer.head', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_chunk', full_name='framework_buffer.Buffer._chunk',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_separator', full_name='framework_buffer.Buffer._separator',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_signal', full_name='framework_buffer.Buffer._signal',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_head', full_name='framework_buffer.Buffer._head',
...
Empty = _reflection.GeneratedProtocolMessageType('Empty', (_message.Message,), {
  'DESCRIPTOR' : _EMPTY,
  '__module__' : 'framework_buffer_pb2'
  # @@protoc_insertion_point(class_scope:framework_buffer.Empty)
  })
  ...
  'Head' : _reflection.GeneratedProtocolMessageType('Head', (_message.Message,), {
    ...
    'Partition' : _reflection.GeneratedProtocolMessageType('Partition', (_message.Message,), {
      ...
      'IndexEntry' : _reflection.GeneratedProtocolMessageType('IndexEntry', (_message.Message,), {
        ...
        '__module__' : 'framework_buffer_pb2'
        # @@protoc_insertion_point(class_scope:framework_buffer.Buffer.Head.Partition.IndexEntry)
        })
      ,
      'DESCRIPTOR' : _BUFFER_HEAD_PARTITION,
      '__module__' : 'framework_buffer_pb2'
      # @@protoc_insertion_point(class_scope:framework_buffer.Buffer.Head.Partition)
      })
    ,
    'DESCRIPTOR' : _BUFFER_HEAD,
    '__module__' : 'framework_buffer_pb2'
    # @@protoc_insertion_point(class_scope:framework_buffer.Buffer.Head)
    })
  ,
  'DESCRIPTOR' : _BUFFER,
  '__module__' : 'framework_buffer_pb2'
  # @@protoc_insertion_point(class_scope:framework_buffer.Buffer)
  })
